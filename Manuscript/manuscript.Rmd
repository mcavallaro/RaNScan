---
title: "Detection of outbreaks from rare serotypes"
...
authors recommended by DT (no ordere): Massimo Cavallaro, Derren Ready (send the data), Dan Todkill, Theresa Lamagni(GAS expert), Noel D. McCarthy, Matt J. Keeling
...
detection system is a naïve inference of an arbitrary count process -- a *null
...
<!-- Synthetic data are powerful resources for assessing a method’s ability to -->
...
outbreak scenarios [@Morbey2015; @Noufaily2019].

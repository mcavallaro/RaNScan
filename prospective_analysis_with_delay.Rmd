...
write.csv(dataframe.to.export, file = paste0('emmtype_', emmtype, '_with_delay_sf1.2.csv'))
```
...
plot(range(weeks), c(0,1), col='white', xlab = 'week', ylab='warning score')
for (i in 1:2300){
  if( !is.na(emmtype_44_0_sf1_2[i,'x'])){
    lines(weeks, unlist(emmtype_44_0_sf1_2[i,71:214]))
  }
}
abline(h=0.95)

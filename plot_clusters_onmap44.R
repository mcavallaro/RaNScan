...
ranScanPlotCluster3(tmp.44, case.df.tmp1, emmtype, Legend = T, xlim=c(-12,8.5))
dev.off()
...
png('Manuscript/_44.0clust.png', res=500, width = 5, height = 4, units='in')
par(fig=c(0, 1, 0, 1))
par(mar=c(0, 0, 0, 4))
